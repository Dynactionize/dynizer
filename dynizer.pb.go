...
const file_dynizer_proto_rawDesc = "" +
	...
	"\tInstances\x1aYDelete an **Instance** (soft delete marks it as deleted without removing persisted data).*\x0eDeleteInstance\x82\xd3\xe4\x93\x02!*\x1f/api/v2/instances/{instance_id}\x12\x8d\x01\n" +
